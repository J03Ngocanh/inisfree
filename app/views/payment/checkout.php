...
<head>
    ...
    <style>
        ...
        /* Flexbox for radio and label alignment */
        .radio-group {
            display: flex;
            align-items: center;
            margin-bottom: 10px;
    ...
    <div class="container">
        <div class="left-section">
            ...
            <table cellspacing="0" cellpadding="8">
                ...
                <input id="subtotal" type="hidden" name="subtotal" value="<?php echo $subtotal; ?>">
                <input id="discount" type="hidden" name="discount" value="<?php echo $discountPercent; ?>">
                <input id="total_to_pay" type="hidden" name="total_to_pay" value="<?php echo $totalToPay; ?>">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (json.orderId) {
                            ...
                            reject("Unable to create order. Please try again.");
                        }
                    },
                    error: function (xhr) {
        ...
        submitBtnElement.addEventListener("click", function (event) {
            ...
            if (paymentMethod === "bank_transfer" && !isPopupConfirmed) {
                ...
                const orderData = {
                    ...
                    recipient_name: document.querySelector("#recipient_name").value,
                    recipient_address: document.querySelector("#recipient_address").value,

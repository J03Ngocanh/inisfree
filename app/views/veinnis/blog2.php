...
<section class="blog-content">
    <div class="content-container">
        ...
        <div class="blog-header">
            <h1>Benefits of Innisfree Vitamin C for your skin</h1>
            <img src="/inis/public/img/dai.png" alt="aaaa" class="blog-image">
        </div>

        <!-- Nội dung bài viết -->
        <div class="blog-body">
            <p><strong>Có thể nói Vitamin có vai trò vô cùng quan trọng, hãy cấp đủ vitamin C cho da bạn nhé </strong>
            </p>
        </div>
    </div>
</section>
